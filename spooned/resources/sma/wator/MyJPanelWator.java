...
public class MyJPanelWator extends javax.swing.JPanel {
    ...
    public void paintComponent(java.awt.Graphics g) {
        ...
        if ((resources.sma.wator.MyJPanelWator.this.map) != null) {
            for (int i = 0; i < (resources.sma.utils.Utils.grideSizeX); i++) {
                for (int j = 0; j < (resources.sma.utils.Utils.grideSizeY); j++) {
                    if ((resources.sma.wator.MyJPanelWator.this.map[i][j]) != null) {
                        g.setColor(resources.sma.wator.MyJPanelWator.this.map[i][j]);
    ...
    public void setMap(java.awt.Color[][] map) {
        resources.sma.wator.MyJPanelWator.this.map = map;
    }
}
