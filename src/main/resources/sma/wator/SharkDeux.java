...
public class SharkDeux extends MarinCreature{
    private int starvingTime = 0;

    public SharkDeux(int x, int y, Wator environement) {
    ...
    private boolean isOccupied(int x, int y){
        ...
        return false;//this.environement.getAgent(x, y) != null && this.environement.getAgent(x,y) instanceof Shark;
    }
